	        ...
	        <div class="psd-bd J_click">
	            <form id="psdForm" name="psdForm" method="post" onsubmit="return check()" action="../deal/Change-Password.php">
	                <div class="line">
						...
						<input type="password" class="text-input" id="nowpsd" name="nowpsd" />
					</div>
					<div class="line">
						<div class="label">新密码: &nbsp;</div>
						<input type="password" class="text-input" id="newpsd" name="newpsd" />
					</div>
					<div class="line">
						<div class="label">确认密码: &nbsp;</div>
						<input type="password" class="text-input" id="againpsd" name="againpsd" />
					</div>
					<div class="line">
					    <div class="label"></div>
